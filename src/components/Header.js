...
function Header() {
  ...
  return (
    <>
      ...
      <aside
      id="logo-sidebar"
      className={`fixed top-16 left-0 z-40 w-full h-16 bg-gray-500 border-t border-gray-800 dark:bg-gray-800 dark:border-gray-700 transition-transform ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'} sm:translate-x-0 sm:w-full sm:static sm:h-auto sm:border-0`}
      aria-label="Sidebar"
    >
    ...
    <ul className="flex space-x-4 font-medium">
      ...
      <li>
        ...
        >
          ...
          <span className="ms-3 text-base sm:text-lg md:text-xl lg:text-2xl sm:ms-4 md:ms-5">Dashboard</span>
            ...
            <li>
              ...
              >
                ...
                <span className="ms-3 text-base sm:text-lg md:text-xl lg:text-2xl sm:ms-4 md:ms-5">Chat</span>
              </NavLink>
            </li>
            <li>
              <NavLink
              ...
              >
                ...
                <span className="ms-3 text-base sm:text-lg md:text-xl lg:text-2xl sm:ms-4 md:ms-5">Sign Up</span>
              </NavLink>
            </li>
          </ul>
        </div>
